...
import { AdminPanelSettings, Delete, Edit, PersonOutline, Storefront } from "@mui/icons-material";
import {
  Box,
  Chip,
  CircularProgress,
...
import { Header, HeaderPattern, PageContainer, StyledButton } from "../ui/StyledComponents";
...
const UserManagement: React.FC = () => {
  const { users, loading, error, fetchUsers, deleteUser, updateUserRole } = useUsers();
    ...
    <PageContainer>
      ...
      <Container maxWidth="lg">
        {users.length === 0 ? (
          ...
          <TableContainer
            component={Paper}
            sx={{ mt: 4, borderRadius: "12px", boxShadow: "0 4px 12px rgba(0,0,0,0.1)" }}
          >
            <Table>
                    ...
                    <TableRow key={user._id} hover>
                        ...
                        {editRoleId === user._id ? (
                          ...
                          <>
                            <Chip
                              ...
                              label={info.label}
                              size="small"
                              sx={{ bgcolor: info.bgcolor, color: info.fontColor, mr: 1 }}
                            />
                            <IconButton
                      ...
                      <TableCell align="center">
                        <IconButton
                          ...
                          sx={{ color: "#f44336" }}
                          disabled={user.role === "admin" || loading} // Evita excluir admin e enquanto carrega
                        >
