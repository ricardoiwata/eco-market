...
const ProductList: React.FC = () => {
  ...
  useEffect(() => setPage(1), [searchTerm, selectedCategory, priceRange, sortBy]);
  ...
  const getEmptyMessage = () => {
    if (searchTerm) return `Não encontramos produtos correspondentes a "${searchTerm}".`;
        ...
        <Container maxWidth="lg">
          ...
          >
            ...
            <Box display="flex" gap={1} position="relative">
              ...
              >
                <MenuItem onClick={() => handleSortOptionSelect("featured")}>Em destaque</MenuItem>
                <MenuItem onClick={() => handleSortOptionSelect("newest")}>Mais recentes</MenuItem>
                <MenuItem onClick={() => handleSortOptionSelect("price-low")}>Menor preço</MenuItem>
